<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InformList.aspx.cs" Inherits="TuShuJieYueYi_Web.Admin.Inform.InformList" %>
...
<body>
    <form id="form1" runat="server">
        <div id="button" class="mt10">
            <input type="button" name="button" class="btn btn82 btn_add" value="发布" runat="server" onclick="javascript: window.location.href = 'InformAdd.aspx'" />
                    ...
                    <div class="pagination">
                       ...
                       <%-- 分页空间，需要进行外部dll文件引用才能够使用--%>
                            <webdiyer:AspNetPager ID="pager" runat="server" OnPageChanged="pager_PageChanged"
                                ...
                                CustomInfoTextAlign="Right" ShowCustomInfoSection="Left" BackColor="#DBF3F7" BorderColor="#95DDFF" BorderWidth="1px" CustomInfoStyle="" MoreButtonType="Image" NavigationButtonType="Image" NumericButtonType="Image" PagingButtonSpacing="12px">
