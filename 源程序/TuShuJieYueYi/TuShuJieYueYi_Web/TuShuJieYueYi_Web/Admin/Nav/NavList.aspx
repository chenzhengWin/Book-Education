<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NavList.aspx.cs" Inherits="TuShuJieYueYi_Web.Admin.Nav.NavList" %>
...
<body>
    <form id="form1" runat="server">
        <div id="button" class="mt10">
            <input type="button" name="button" class="btn btn82 btn_add" value="新增" runat="server" onclick="javascript: window.location.href = 'NavAdd.aspx'" />
        </div>
        <div id="table" class="mt10">
            <div class="box span10 oh">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table" style="text-align: center">
                    <asp:Repeater ID="repNavList" runat="server" OnItemCommand="repList_ItemCommand"><%-- OnItemCommand="repListItemCommand"--%>
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr class="tr">
                                ...
                                <td class="td_center">
                                   ...
                                   <%-- <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%#Eval("User_ID") %>'
