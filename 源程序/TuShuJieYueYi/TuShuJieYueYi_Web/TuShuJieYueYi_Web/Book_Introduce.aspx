<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Introduce.aspx.cs" Inherits="TuShuJieYueYi_Web.Book_Introduce" %>
        ...
        function LoadFoot() {
            ...
            $.getJSON("Loading.ashx", { action: 1 }, function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    $("#footer").append(" <li><a href='#'>" + item.Name + "</a>|</li>");
                })
                ...
                <div class="col-xs-0 col-md-3">
                    <p class="index-badge">
                        <a href="#"><span class="badge">
                            <img src="img/icon01.png" width="12" height="16"></span>修改密码</a>
                    </p>
                </div>
            </div>
    ...
    <div class="bg02">
        <div class="container">
            <div class="row new-book">
                <div class="col-xs-12">
                    <div id="book_content" class="book" runat="server">
                        <%--后台填充--%>
                    </div>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <li><a href="Labrary_introduce.aspx">图书馆简介</a></li>--%>
                ...
                <div class="pull-right footer-link">
                    <a href="#">
                        <img src="img/icon11.png" width="34" height="34" /></a>
                    <a href="#">
                        <img src="img/icon12.png" width="34" height="34" /></a>
                    <a href="#">
                        <img src="img/icon13.png" width="34" height="34" /></a>
                </div>
            </div>
        </div>
    </footer>
